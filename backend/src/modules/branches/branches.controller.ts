...
import { CreateBranchDto, UpdateBranchDto, AssignUserToBranchDto, UpdateUserBranchAccessDto } from './dto/branch.dto';
...
export class BranchesController {
  ...
  async createBranch(
    ...
    const tenantId = user?.tenantId || createBranchDto.tenantId || req.headers['x-tenant-id'];
  ...
  async assignUserToBranch(
    ...
    return this.branchesService.assignUserToBranch(assignUserToBranchDto, branchId);
  }
  ...
  async updateUserBranchAccess(
    ...
    return this.branchesService.updateUserBranchAccess(updateUserBranchAccessDto, userId, branchId);
  }
}
